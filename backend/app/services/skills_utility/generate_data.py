...
group_ids = [
    "68934ca40f3f20b5b2ed9bc7",
    "68934ca40f3f20b5b2ed9bc8",
    "68934ca40f3f20b5b2ed9bc9",
    "68934ca40f3f20b5b2ed9bca",
]
...
raw_demand = [
    {
        ...
        "attributes": {
            "earnings_per_month": "earn_70k",
            "task_content": "task_creative",
            "physical_demand": "phys_light",
            "work_flexibility": "flex_high",
            "social_interaction": "soc_alone",
            "career_growth": "growth_high",
            "social_meaning": "mean_low",
            "expected_demand": "Very Low Expected Demand",
        },
        "essential": [skill_ids["tech"]],
        "group": group_ids[0],
    },
    {
        "uuid": "job_002",
        "originUuid": "const_01",
        "opportunity_title": "Site Foreman",
        "location": "Nairobi",
        "contract_type": "contract",
        "attributes": {
            "earnings_per_month": "earn_50k",
            "task_content": "task_mix",
            "physical_demand": "phys_heavy",
            "work_flexibility": "flex_fixed",
            "social_interaction": "soc_people",
            "career_growth": "growth_med",
            "social_meaning": "mean_low",
            "expected_demand": "Very Low Expected Demand",
        },
        "essential": [skill_ids["const"]],
        "group": group_ids[1],
    },
    {
        "uuid": "job_003",
        "originUuid": "med_01",
        "opportunity_title": "Community Health Nurse",
        "location": "Kisumu",
        "contract_type": "full_time",
        "attributes": {
            ...
            "task_content": "task_mix",
            "physical_demand": "phys_light",
            "work_flexibility": "flex_some",
            "social_interaction": "soc_people",
            "career_growth": "growth_high",
            "social_meaning": "mean_high",
            "expected_demand": "Very Low Expected Demand",
        },
        "essential": [skill_ids["med"]],
        "group": group_ids[2],
    },
    {
        "uuid": "job_004",
        "originUuid": "sales_01",
        "opportunity_title": "Regional Sales Manager",
        "location": "Mombasa",
        "contract_type": "full_time",
        "attributes": {
            "earnings_per_month": "earn_70k",
            ...
            "career_growth": "growth_high",
            "social_meaning": "mean_low",
            "expected_demand": "High Expected Demand",
        },
        "essential": [skill_ids["sales"]],
        "group": group_ids[3],
    },
    {
        "uuid": "job_005",
        "originUuid": "design_01",
        "opportunity_title": "Freelance Graphic Designer",
        "location": "Remote",
    ...
    },
    {
        ...
        "attributes": {
            "earnings_per_month": "earn_30k",
            "task_content": "task_routine",
            "physical_demand": "phys_heavy",
            "work_flexibility": "flex_some",
            "social_interaction": "soc_alone",
            "career_growth": "growth_low",
            "social_meaning": "mean_low",
            "expected_demand": "Moderate Expected Demand",
        },
        "essential": [skill_ids["logistics"]],
        "group": group_ids[1],
    },
    {
        "uuid": "job_007",
        "originUuid": "edu_01",
        "opportunity_title": "Primary School Teacher",
        "location": "Eldoret",
        "contract_type": "full_time",
        "attributes": {
            "earnings_per_month": "earn_30k",
        ...
        "essential": [skill_ids["edu"]],
        "group": group_ids[2],
    },
    {
        "uuid": "job_008",
        "originUuid": "fin_01",
        "opportunity_title": "Junior Accountant",
        "location": "Nairobi",
        ...
        "essential": [skill_ids["fin"]],
        "group": group_ids[3],
    },
    {
        "uuid": "job_009",
        "originUuid": "tech_02",
        "opportunity_title": "Electrician Assistant",
        "location": "Thika",
        "contract_type": "contract",
        "attributes": {
            "earnings_per_month": "earn_30k",
    ...
    },
    {
        ...
        "essential": [skill_ids["hosp"]],
        "group": group_ids[1],
    },
    {
        "uuid": "job_011",
        "originUuid": "admin_01",
        "opportunity_title": "Data Entry Clerk",
        "location": "Remote",
        "contract_type": "part_time",
        "attributes": {
            "earnings_per_month": "earn_15k",
            "task_content": "task_routine",
            "physical_demand": "phys_light",
            "work_flexibility": "flex_high",
            "social_interaction": "soc_alone",
            "career_growth": "growth_low",
            "social_meaning": "mean_low",
            "expected_demand": "Low Expected Demand",
        },
        "essential": [skill_ids["admin"]],
        "group": group_ids[2],
    },
    {
        "uuid": "job_012",
        "originUuid": "sec_01",
        "opportunity_title": "Night Guard",
        "location": "Nairobi",
        "contract_type": "full_time",
        "attributes": {
            "earnings_per_month": "earn_15k",
        ...
        "essential": [skill_ids["sec"]],
        "group": group_ids[3],
    },
    {
        "uuid": "job_013",
        "originUuid": "agri_01",
        "opportunity_title": "Farm Hand",
        "location": "Naivasha",
        ...
        "essential": [skill_ids["agri"]],
        "group": group_ids[0],
    },
    {
        "uuid": "job_014",
        "originUuid": "const_02",
        "opportunity_title": "Carpenter",
        "location": "Kisumu",
        "contract_type": "contract",
        "attributes": {
            "earnings_per_month": "earn_30k",
    ...
    },
    {
        "uuid": "job_015",
        "originUuid": "serv_01",
        "opportunity_title": "Call Center Agent",
        "location": "Nairobi",
        "contract_type": "full_time",
        "attributes": {
            "earnings_per_month": "earn_30k",
    ...
    },
    {
        "uuid": "job_018",
        "originUuid": "man_01",
        "opportunity_title": "Factory Machine Operator",
        ...
        "essential": [skill_ids["manuf"]],
        "group": group_ids[1],
    },
    {
        "uuid": "job_019",
        "originUuid": "beauty_01",
        "opportunity_title": "Hair Stylist",
        "location": "Westlands",
        ...
        "essential": [skill_ids["beauty"]],
        "group": group_ids[2],
    },
    {
        "uuid": "job_020",
        "originUuid": "const_04",
        "opportunity_title": "Welder",
        "location": "Thika",
        "contract_type": "contract",
        "attributes": {
            "earnings_per_month": "earn_30k",
...
with open("demand.jsonl", "w") as f:
    for item in raw_demand:
        ...
        record = {
            ...
            "essential_skills": [
                {"id": str(u), "label": ""} for u in item["essential"]
            ],
            "optional_skills": [],
